...
# figuur op basis van gam modellen
# link met mi data
...
save(fd_trends, file = here("source", "fd", "fd_trends_plot_data.rdata"))

load(file = here("source", "fd", "fd_trends_plot_data.rdata"))
...
ggsave(
  filename =  here("output", "figuren", "CWM_trend_current_velocity.png"),
  plot = last_plot(), # Expliciet de laatste plot kiezen
  width = 40,
  height = 20,
  units = "cm",
