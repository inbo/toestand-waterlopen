...
plot_waterlopen_statuut <- function(input_data, statuut_input, titel_input, aantal_knots) {
...
plot_waterlopen_statuut(mi_data_analyse, "Natuurlijk", "Natuurlijke waterlopen", aantal_knots = 3)
plot_waterlopen_statuut(mi_data_analyse, "Natuurlijk", "Natuurlijke waterlopen")




plot_waterlopen_statuut(mi_data_analyse %>% filter(!groep %in% c("overgangswater", "zeer_grote_rivier")), "Sterk Veranderd", "Sterk veranderde waterlopen", aantal_knots = 3)

plot_waterlopen_statuut(mi_data_analyse, "Sterk Veranderd", "Sterk veranderde waterlopen", aantal_knots = 3)
