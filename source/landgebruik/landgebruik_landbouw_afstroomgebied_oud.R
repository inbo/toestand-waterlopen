...
print(head(intensiteit_landbouw_afstroomgebieden_scores))

save(intensiteit_landbouw_afstroomgebieden_scores, file = here("data", "verwerkt", "landgebruik", "intensiteit_landbouw_scores_afstroomgebieden.rdata"))

load(here("data", "verwerkt", "landgebruik", "intensiteit_landbouw_scores.rdata"))

oud <- intensiteit_landbouw_scores
nieuw <- intensiteit_landbouw_afstroomgebieden_scores
cor.test(oud$intensiteit_combo, nieuw$intensiteit_combo)
